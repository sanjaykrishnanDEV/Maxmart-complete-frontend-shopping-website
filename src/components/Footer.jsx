...
export default function Footer() {
  return (
    <footer className="relative bottom-0 right-0 bg-neutral-100 text-center text-neutral-600 dark:bg-neutral-600 dark:text-neutral-200 lg:text-left">
      ...
      <div className="mx-6 py-10 text-center md:text-left">
        <div className="grid-1 grid gap-8 md:grid-cols-2 lg:grid-cols-4">
          ...
          <div className="">
            ...
            <p>
              <a className="text-neutral-600 dark:text-neutral-200">Lighting</a>
            </p>
          </div>
